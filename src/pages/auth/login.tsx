				...
				<Col span={15} className="pt-20 pb-10 px-10 flex items-center justify-center flex-col bg-[#fff]">
					<Space direction="vertical" align="center" size="small">
						...
						>
							...
							>
								<Input className="rounded-none border-b-2 border-t-0 border-x-0 focus-within:shadow-none" />
							</Form.Item>
							<Form.Item<FieldType>
							...
							>
								<Input.Password className="rounded-none border-b-2 border-t-0 border-x-0 focus-within:shadow-none" />
							</Form.Item>
							<Form.Item>
