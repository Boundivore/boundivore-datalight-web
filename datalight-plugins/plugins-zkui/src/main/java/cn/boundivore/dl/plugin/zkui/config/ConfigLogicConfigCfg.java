 ...
 * Version: V1.0
 */
public class ConfigLogicConfigCfg extends AbstractConfigLogic {

    public ConfigLogicConfigCfg(PluginConfig pluginConfig) {
        super(pluginConfig);
    }
    ...
    public String config(File file, String replacedTemplated) {
        ...
        // {{zkServer}}
        String zkServer = this.zkServer();

        // {{h2.jdbcUrl}}
        String h2JdbcUrl = this.h2JdbcUrl();
    ...
    /**
     * Description: 获取 Zookeeper 集群连接地址
     * Created by: Boundivore
     * E-mail: boundivore@foxmail.com
     * Creation time: 2024/5/7
     * Modification description:
     ...
     * Throws:
     *
     * @return String Zookeeper 集群连接地址
     */
